...
<h1>Program Menentukan Zodiak</h1> 
<h1>Program by MUHAMMAD RAFLI</h1>
</div>
</div>
</div>
      ...
      <form  method="post" >
        ...
        <p>
          ...
          <select name="tahun" size="1" class="form-control">
            ...
            <?php  for ($tahun = 1980;$tahun <= 2019;$tahun++) { ?>
...
$tahun = date('Y');
 ...
 if($nama != "" && $bulan != 'Bulan' && $tanggal != 'Tanggal' && $tahun != 'Tahun' && $gender != 'gender'){
...
<p>Zodiak Anda</p>
<input name="" type="text" enabled="false" value="<?php echo $zodiak ?>" class="form-control"/>
<p>Kepribadian Anda</p>
<textarea cols="100" rows="3" value="" ><?php echo $kep ?></textarea>
<p>Ramalan Anda </p>
<textarea cols="100" rows="5" value="" ><?php echo $ramalan ?></textarea>
